...
import back from '../img/bkglit.jpg'
...
function setNivelesHabilitados() {
  localStorage.setItem('nivelComLec', 1);
  localStorage.setItem('nivelCheckPalabra', 1);
          ...
          <form className={classes.form} noValidate>
            ...
            <Button
              ...
              onClick={() => {
                ...
                localStorage.setItem('nombreJugador', document.querySelector("#nombre").value);
                setNivelesHabilitados();
                resetPuntaje();
              }}>
              Jugar
              </Button>
